...
from model import Rock_CNN  # 导入自定义的卷积神经网络模型类（假设您的CNN模型保存在cnn_model.py中）
...
# 数据集
train_path = r'./dataset/data/train'
#val_path = r'./dataset/data/val'
test_path = r'./dataset/data/test'
...
model = Rock_CNN(out_num).to(device)
